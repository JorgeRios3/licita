...
urlpatterns = [
    ...
    re_path(r'^set-new-password/$', views.set_new_password, name='set_new_password'),
    path('reset-new-password/<hash>', views.reset_new_password, name='reset_new_password'),
    #path('register-done/', views.RegisterDonePageView.as_view(), name='register_done2'),
    re_path(r'^register-done/$', views.RegisterDone, name='register'),
    ...
    path('delete_group_user', filtros.delete_group_user, name="delete_group_user"),
    path('add_user_permision', filtros.add_user_permision, name="add_user_permision"),
    path('delete_user_permision', filtros.delete_user_permision, name="delete_user_permision"),
